...
public class GeneratePeople {
    public static void main(String[] args) {
        ...
        int dataLength = 100;
        List<Person> dataList = makeData(dataLength);
     ...
     * @return
     */
    public static List<Person> makeData(int dataLength) {
        ...
        for (int i = 0; i < dataLength; i++) {
            ...
            person.setGender(getGenderById(idCardNumber));
            person.setAge(getAgeById(idCardNumber));
     ...
     */
    private static String getGenderById(String idCardNumber) {
        String gender;
        String genderDigit = idCardNumber.substring(idCardNumber.length() - 2, idCardNumber.length() - 1);
    ...
    private static String getAgeById(String idCardNumber) {
        // 7-14位为生日
        String birthStr = idCardNumber.substring(6, 14);
        SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");
        try {
            Date birthDay = format.parse(birthStr);
            Calendar now = Calendar.getInstance();
            Calendar birth = Calendar.getInstance();
            birth.setTime(birthDay);

            int difference = now.get(Calendar.YEAR) - birth.get(Calendar.YEAR);
            return difference + "岁";
...
//        System.out.println("区号：" + locationCode);
    ...
    public static String randomBirthday() {
        ...
        builder.append(date);
//        System.out.println("生日：" + builder.toString());
